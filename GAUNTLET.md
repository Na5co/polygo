...
- G6.3: docs/demo.gif (51 KB, 15 s, qwen3:8b via scripts/demo.sh — vhs 0.12 cannot encode with ffmpeg 9, so the script assembles frames); README with $149/mo Lokalise link, format table, sandbox-exec offline proof, security note; scripts/review_readme.sh → gemma4 5/5.
